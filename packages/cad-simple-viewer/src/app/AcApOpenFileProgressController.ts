 ...
 * until {@link setSceneBusyGate} reports idle. Progressive opens typically
 * gate on convert **and** deferred glyph jobs so pan/zoom stay blocked while
 * the canvas is still catching up under the spinner.
 */
