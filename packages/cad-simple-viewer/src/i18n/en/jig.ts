export default {
  ...
  offset: {
    ...
    eraseOn: 'Erase source objects after offsetting? Yes',
    eraseOff: 'Erase source objects after offsetting? No',
    layerSource: 'Offset object layer: Source',
    layerCurrent: 'Offset object layer: Current',
    keywords: {
