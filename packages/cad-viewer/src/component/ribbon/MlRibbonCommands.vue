...
const ribbonData = computed(() => {
  ...
  commandByItemId.set('cmd-tool-rev-freehand', 'ansketch')
  commandByItemId.set('cmd-tool-rev-rect', 'anrect')
  commandByItemId.set('cmd-tool-rev-cloud', 'ancloud')
  commandByItemId.set('cmd-tool-rev-circle', 'anellipse')
  commandByItemId.set('cmd-tool-rev-vis', 'annvis')
