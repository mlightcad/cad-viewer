...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    '^@mlightcad/cad-simple-ui-plugin/toolbar$':
      '<rootDir>/packages/cad-simple-ui-plugin/src/toolbar.ts',
    '^@mlightcad/cad-simple-ui-plugin/setup-toolbar$':
      '<rootDir>/packages/cad-simple-ui-plugin/src/setupToolbar.ts',
